...
public class DataInitializer implements CommandLineRunner {
    ...
    private void inicializarCatalogoYEmpleados() {
        ...
        crearEmpleadoSiNoExiste("May Menendez", "ganta4315@gmail.com", especialidadAtencion);
        ...
        Map<String, List<Servicio>> serviciosPorCorreo = Map.of(
                ...
                "ganta4315@gmail.com", serviciosSalud
        );
    ...
    private void crearEmpleadoSiNoExiste(String nombre, String correo, Especialidad especialidad) {
        ...
        if (existente.isPresent()) {
            ...
            System.out.println("[DataInitializer] Usuario " + correo + " ya existe como " + usuario.getRol() + ", saltando creación de empleado.");
            return;
        }
