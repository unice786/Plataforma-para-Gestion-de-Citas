...
public class CatalogoServicioController {
    ...
    public String mostrarReserva(
            @org.springframework.web.bind.annotation.RequestParam(value = "servicioId", required = false) Long servicioId,
        ...
        if (servicioId != null) {
            model.addAttribute("servicioPreseleccionado", servicioId);
        }
